                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Batch Name</th>
                            <th class="font-weight-bold">Course Name</th>
                            <th class="font-weight-bold">StartDate</th>
                            <th class="font-weight-bold">EndDate</th>
...
$sql="SELECT * from tblbatch LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>   
                          <tr>
                            ...
                            <td><?php  echo htmlentities($row->BatchName);?></td>
                            <td><?php  echo htmlentities($row->CourseName);?></td>
                            <td><?php  echo htmlentities($row->StartDate);?></td>
                            <td><?php  echo htmlentities($row->EndDate);?></td>
                            <td><?php  echo htmlentities($row->CreationDate);?></td>
                            <td>
                              <div><a href="edit-batch-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-batch.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
