...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $notmsg=$_POST['notmsg'];
 $eid=$_GET['editid'];
$sql="update tblnotice set NoticeTitle=:nottitle,BatchName=:batchname, NoticeMsg=:notmsg where ID=:eid";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <?php
$eid=$_GET['editid'];
$sql="SELECT * from tblnotice where tblnotice.ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                      ...
                      <div class="form-group">
                        ...
                        <select  name="batchname" class="form-control">
                          <option value="<?php  echo htmlentities($row->BatchName);?>"><?php  echo htmlentities($row->BatchName);?></option>
                         <?php 
