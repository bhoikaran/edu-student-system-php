                    ...
                    <form method="post">
                                <div class="form-group">
                                   <strong>Search Student:</strong>
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search by Student ID OR Student Name Or Mobile Number or Email"></div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Student Batch</th>
...
$sql="select * from tblstudent where StuID=:sdata OR StudentName=:sdata OR StudentEmail=:sdata OR ContactNumber=:sdata";
$query = $dbh -> prepare($sql);
...
{               ?>   
                          ...
                          <td><?php echo htmlentities($cnt);?></td>
                            ...
                            <td><?php  echo htmlentities($row->StudentBatch);?></td>                    
