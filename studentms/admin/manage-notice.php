                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">BatchName</th>
...
#$sql="SELECT tblbatch.ID,tblbatch.CourseName,tblbatch.BatchName,tblnotice.NoticeTitle,tblnotice.CreationDate,tblnotice.CourseId,tblnotice.ID as nid from tblnotice join tblbatch on tblbatch.ID=tblnotice.CId LIMIT $offset, $no_of_records_per_page";
