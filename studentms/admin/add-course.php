...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $fee=$_POST['fee'];
 $total=$_POST['total'];
$sql="insert into tblcourse(CourseName,Fee,Tot_Years)values(:cname,:fee,:total)";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="fee" value="" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Total Years</label>
                        <input type="text" name="total" value="" class="form-control" required='true'>
                      </div>
