                    ...
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        ...
                        ?>
                          ...
                          <h4><?php echo htmlentities($totcourse);?></h4>
                      ...
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                           <?php 
                        $sql1 ="SELECT * from  tblbatch";
                        $query1 = $dbh -> prepare($sql1);
                        $query1->execute();
                        $results1=$query1->fetchAll(PDO::FETCH_OBJ);
                        $totbatch=$query1->rowCount();
                        ?>
                          <span class="report-title">Total Batches</span>
                          <h4><?php echo htmlentities($totbatch);?></h4>
                          <a href="manage-batch.php"><span class="report-count"> View Batches</span></a>
                        </div>
